...
RSpec.describe 'Matcher Examples' do
  ...
  it 'embedding matchers in array and hash data structures' do
  ...
  it 'combining matchers with logical and/or operators' do
    alphabet = ('a'..'z').to_a
    ...
    expect(%w[a z]).to start_with_a_and_end_with_z
